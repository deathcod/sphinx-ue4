...
static struct FScriptStruct_SpeechRecognition_StaticRegisterNativesFRecognisedPhrases
{
	...
	IMPLEMENT_CLASS(ASpeechRecognitionActor, 1793471171);
...
// Cross Module References
	...
	UEnum* Z_Construct_UEnum_SpeechRecognition_ESpeechRecognitionLanguage()
	{
		...
		if (!ReturnEnum)
		{
			...
			EnumNames.Add(TPairInitializer<FName, uint8>(FName(TEXT("ESpeechRecognitionLanguage::VE_MAX")), 3));
			ReturnEnum->SetEnums(EnumNames, UEnum::ECppForm::EnumClass);
	...
	uint32 Get_Z_Construct_UEnum_SpeechRecognition_ESpeechRecognitionLanguage_CRC() { return 2069778345U; }
	...
	UEnum* Z_Construct_UEnum_SpeechRecognition_ESpeechRecognitionMode()
	{
		...
		if (!ReturnEnum)
		{
			...
			EnumNames.Add(TPairInitializer<FName, uint8>(FName(TEXT("ESpeechRecognitionMode::VE_MAX")), 2));
			ReturnEnum->SetEnums(EnumNames, UEnum::ECppForm::EnumClass);
	...
	uint32 Get_Z_Construct_UEnum_SpeechRecognition_ESpeechRecognitionMode_CRC() { return 3599856704U; }
...
PRAGMA_ENABLE_DEPRECATION_WARNINGS
				...
				OuterClass->AddFunctionToFunctionMapWithOverriddenName(Z_Construct_UFunction_ASpeechRecognitionActor_Init(), "Init"); // 81507731
				OuterClass->AddFunctionToFunctionMapWithOverriddenName(Z_Construct_UFunction_ASpeechRecognitionActor_SetConfigParam(), "SetConfigParam"); // 510715674
